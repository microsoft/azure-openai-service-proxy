...
--
-- Name: TABLE active_attendee_growth_view; Type: ACL; Schema: aoai; Owner: azure_pg_admin
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE aoai.active_attendee_growth_view TO aoai_proxy_app;

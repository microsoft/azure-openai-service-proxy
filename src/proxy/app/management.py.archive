...
class ManagementService:
    ...
    def _create_table(self):
        ...
        try:
            ...
            self.logging.error("HTTP response exception adding event request: %s", azure_error.message)
            raise HTTPException(
                status_code=504,
            ...
            self.logging.error("General exception creating table: %s", exception.args[0])
            raise HTTPException(
                status_code=500,
    ...
    async def add_new_event(self, event_request: NewEventRequest):
        ...
        try:
            ...
            self.logging.error("General exception adding event request: %s", exception.args[0])
            raise HTTPException(
                status_code=500,
    ...
    async def list_events(self, query: str):
        ...
        try:
            ...
            self.logging.error("HTTP response exception getting event request: %s", azure_error.message)
            raise HTTPException(
                status_code=504,
            ...
            self.logging.error("General exception getting event request: %s", exception.args[0])
            raise HTTPException(
                status_code=500,
    ...
    async def upsert_model_deployment(self, model_deployment: ModelDeploymentRequest):
        ...
        try:
            ...
            self.logging.error("General exception adding model deployment: %s", exception.args[0])
            raise HTTPException(
                status_code=500,
    ...
    async def list_model_deployments(self, query: str):
        ...
        try:
            async with AsyncTableClient.from_connection_string(
                ...
                async for entity in queried_entities:
                    try:
                        ...
                        self.logging.error("Invalid deployment class: %s", entity.get("PartitionKey"))
            ...
            self.logging.error("General exception getting model deployment: %s", exception.args[0])
            raise HTTPException(
                status_code=500,

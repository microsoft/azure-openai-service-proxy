...
public partial class AoaiProxyContext
{
    ...
    {
        // int result = await Database.ExecuteSqlRawAsync(
        //     $"aoai.add_event p_owner_id=@OwnerId p_event_code=@EventCode p_event_markdown=@EventMarkdown p_start_utc=@StartUtc p_end_utc=@EndUtc p_organizer_name=@OrganiserName p_organizer_email=@OrganiserEmail p_event_url=@EventUrl p_event_url_text=@EventUrlText p_max_token_cap=@MaxTokenCap p_single_code=@SingleCode p_daily_request_cap=@DailyRequestCap p_active=@Active",
        //     new NpgsqlParameter("OwnerId", owner.OwnerId),
        //     new NpgsqlParameter("EventCode", newEvent.EventCode),
        //     new NpgsqlParameter("EventMarkdown", newEvent.EventMarkdown),
        //     new NpgsqlParameter("StartUtc", newEvent.StartUtc),
        //     new NpgsqlParameter("EndUtc", newEvent.EndUtc),
        //     new NpgsqlParameter("OrganiserName", newEvent.OrganizerName),
        //     new NpgsqlParameter("OrganiserEmail", newEvent.OrganizerEmail),
        //     new NpgsqlParameter("EventUrl", newEvent.EventUrl),
        //     new NpgsqlParameter("EventUrlText", newEvent.EventUrlText),
        //     new NpgsqlParameter("MaxTokenCap", newEvent.MaxTokenCap),
        //     new NpgsqlParameter("SingleCode", newEvent.SingleCode),
        //     new NpgsqlParameter("DailyRequestCap", newEvent.DailyRequestCap),
        //     new NpgsqlParameter("Active", newEvent.Active));
